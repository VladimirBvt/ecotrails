...
ymaps.ready(function () {
  ...
  //     [44.505151, 33.510385],
  //     {
  //       hintContent: "Фиолентовская тропа",
  //       balloonContent: `<a href="/fiolentovskaya-tropa/"><figure id="Fiolent" class="catalog-item">
  //       <img src="/img/for-slider-21-Крым-Фиолентовская-тропа.jpg" alt="Фиолентовская тропа"
  //           class="trail-img">
  //       <figcaption class="trail-info">
  //           <a href="/fiolentovskaya-tropa/" class="trail-title-link">
  //               <h2 id="color-letters-cot" class="black-color size-card-elem-h2"
  //                   title="Фиолентовская тропа">Фиолентовская тропа</h2>
  //           </a>
  //           <a href="/fiolentovskaya-tropa/" id="trail-location" class="trail-location-black"
  //               title="Республика Крым, мыс Фиолент">
  //               <p id="color-letters-cot" class="black-color size-card-elem-p">Республика Крым,
  //                   мыс Фиолент</p>
  //           </a>
  //           <div class="trail-spec">
  //               <a href="/fiolentovskaya-tropa/" class="trail-distance">
  //                   <div class="img-card-color">
  //                       <img src="/img/dist-orange.svg" alt="Длина тропы">
  //                   </div>
  //                   <p id="color-letters-cot" class="black-color">2 км</p>
  //               </a>
  //               <a href="/fiolentovskaya-tropa/" class="trail-difficulty">
  ...
  //               </a>
  //               <a href="/fiolentovskaya-tropa/" class="trail-duration">
  //                   <div class="img-card-color">
