...
ymaps.ready(function () {
  ...
  // -------------------------------------------------------------------------------Тест------------------------------------------------------
  // .............................................................Высота Мюллера (Калининградская область)
  ...
  var startPoint = new ymaps.Placemark(
    ...
    <figcaption class="trail-info">
        ...
        <div class="trail-spec">
            <a href="/catalog/voronezhskaya-oblast/cherepahinskaya/" class="trail-distance">
                <div class="img-card-color">
                    <img src="/img/dist-orange.svg" alt="Длина тропы">
                </div>
                <p id="color-letters-cot" class="black-color">4,6 км</p>
            </a>
            <a href="/catalog/voronezhskaya-oblast/cherepahinskaya/" class="trail-difficulty">
            ...
            <a href="/catalog/voronezhskaya-oblast/cherepahinskaya/" class="trail-duration">
                <div class="img-card-color">
                    <img src="/img/duration-orange.svg" alt="Длительность тропы">
                </div>
  ...
  var startPoint = new ymaps.Placemark(
    [54.98891205, 20.55999074],
    {
      hintContent: "Экотропа Королевский Бор",

      // Тут контент карточки тропы
      balloonContent: `<a href="/catalog/kaliningradskaya-oblast/korolevsky-bor/">
    <figure id="KorolevskyBor" class="catalog-item">
        <img src="/catalog/kaliningradskaya-oblast/korolevsky-bor/img/for-slider.jpg" alt="Экотропа Королевский Бор"
            class="trail-img">
        <figcaption class="trail-info">
            <a href="/catalog/kaliningradskaya-oblast/korolevsky-bor/" class="trail-title-link">
                <h2 id="color-letters-cot" class="black-color size-card-elem-h2" title="Королевский Бор">Королевский Бор
                </h2>
            </a>
            <a href="/catalog/kaliningradskaya-oblast/korolevsky-bor/" id="trail-location"
                class="trail-location-black" title="Калининградская область, Куршская коса">
                <p id="color-letters-cot" class="black-color size-card-elem-p">
                    Калининградская область, Куршская коса</p>
            </a>
            <div class="trail-spec">
                <a href="/catalog/kaliningradskaya-oblast/korolevsky-bor/" class="trail-distance">
                    <div class="img-card-color">
                        <img src="/img/dist-orange.svg" alt="Длина тропы">
                    </div>
                    <p id="color-letters-cot" class="black-color">2,7 км</p>
                </a>
                <a href="/catalog/kaliningradskaya-oblast/korolevsky-bor/" class="trail-difficulty">
                    <div id="easy" class="img-card-color">
                        <img src="/img/difficulty-easy.svg" alt="Сложность тропы">
                    </div>
                    <p id="color-letters-cot" class="black-color">Простая</p>
                </a>
                <a href="/catalog/kaliningradskaya-oblast/korolevsky-bor/" class="trail-duration">
                    <div class="img-card-color">
                        <img src="/img/duration-orange.svg" alt="Длительность тропы">
                    </div>
                    <p id="color-letters-cot" class="black-color">~1 ч</p>
  ...
  var startPoint = new ymaps.Placemark(
    [60.63089653, 30.1210894],
    {
      hintContent: "Экотропа Петяярви",

      // Тут контент карточки тропы
      balloonContent: `<a href="../catalog/lenoblast/petyayarvi/"><figure id="Petyayarvi" class="catalog-item">
    <img src="../catalog/lenoblast/petyayarvi/img/for-slider.jpg" alt="Экотропа Петяярви" class="trail-img">
    <figcaption class="trail-info">
        <a href="../catalog/lenoblast/petyayarvi/" class="trail-title-link">
            <h2 id="color-letters-cot" class="black-color size-card-elem-h2"
                title="Экотропа Петяярви">Экотропа Петяярви
            </h2>
        </a>
        <a href="../catalog/lenoblast/petyayarvi/" id="trail-location" class="trail-location-black"
            title="Ленинградская область, заказник Гряда Вярямянселькя">
            <p id="color-letters-cot" class="black-color size-card-elem-p">
            Ленинградская область, Гряда Вярямянселькя</p>
        </a>
        <div class="trail-spec">
            <a href="../catalog/lenoblast/petyayarvi/" class="trail-distance">
                <div class="img-card-color">
                    <img src="../../img/dist-orange.svg" alt="Длина тропы">
                </div>
                <p id="color-letters-cot" class="black-color">12,5 км</p>
            </a>
            <a href="../catalog/lenoblast/petyayarvi/" class="trail-difficulty">
                <div id="medium" class="img-card-color">
                    <img src="../../img/difficulty-medium.svg" alt="Сложность тропы">
                </div>
                <p id="color-letters-cot" class="black-color">Средняя</p>
            </a>
            <a href="../catalog/lenoblast/petyayarvi/" class="trail-duration">
                <div class="img-card-color">
                    <img src="../../img/duration-orange.svg" alt="Длительность тропы">
                </div>
                <p id="color-letters-cot" class="black-color">~4,5 ч</p>
            </a>
        </div>
    </figcaption>
   </figure></a>`,
