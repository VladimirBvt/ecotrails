    ...
    function (e) {
        ...
        return (
          a.renderSlide
            ? ((i = a.renderSlide.call(s, e, t)),
              "string" == typeof i && ((n.innerHTML = i), (i = n.children[0])))
            : (i = s.isElement
                ? g("swiper-slide")
      ...
      function o(e) {
        const {
          ...
          { addSlidesBefore: o, addSlidesAfter: d } = s.params.virtual,
        ...
        (v = s.rtlTranslate ? "right" : s.isHorizontal() ? "left" : "top"),
          i
            ? ((w = Math.floor(t / 2) + a + d), (b = Math.floor(t / 2) + a + o))
            : ((w = t + (a - 1) + d), (b = (n ? t : a) + o));
        let y = g - b,
          E = g + w;
